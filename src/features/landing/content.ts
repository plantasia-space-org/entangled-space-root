...
export const designHighlights = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        "Every value in the cycle is generated by the 833 Cents Scale — derived, repeatable, auditable. Even the easing at the peak is inherited from the scale: its smallest intervals sit exactly at the turning point.",
    },
  ],
} as const
